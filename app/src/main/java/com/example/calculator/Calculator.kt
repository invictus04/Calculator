        ...
        Column(modifier = Modifier
            ...
            Row(
                ...
                CalculatorButton(symbol = "AC",
                 ...
                 CalculatorButton(symbol = "%",
                    modifier = Modifier.aspectRatio(1f).weight(1f),
                    onClick = {onAction(CalculatorActions.operation(calculatorOperations.Percentage))}
                )
                 CalculatorButton(symbol = "/",
                    modifier = Modifier.aspectRatio(1f).weight(1f),
                    onClick = {onAction(CalculatorActions.operation(calculatorOperations.Divide))}
                )
            }
            ...
            Row(
                ...
                CalculatorButton(symbol = "7",
                    modifier = Modifier.background(lightgrey).aspectRatio(1f).weight(1f),
                ...
                CalculatorButton(symbol = "x",
                    modifier = Modifier.aspectRatio(1f).weight(1f),
                    onClick = {onAction(CalculatorActions.operation(calculatorOperations.Multiply))}
                )
            }
            ...
            Row(
                ...
                CalculatorButton(symbol = "-",
                    modifier = Modifier.aspectRatio(1f).weight(1f),
                    onClick = {onAction(CalculatorActions.operation(calculatorOperations.Subtract))}
                )
            }
            ...
            Row(
                ...
                CalculatorButton(symbol = "+",
                    modifier = Modifier.aspectRatio(1f).weight(1f),
                    onClick = {onAction(CalculatorActions.operation(calculatorOperations.Add))}
                )
            }
            ...
            Row(
                ...
                CalculatorButton(symbol = "=",
                    modifier = Modifier.background(Color.Black).aspectRatio(1f).weight(1f),
